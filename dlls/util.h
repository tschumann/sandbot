...
inline edict_t* INDEXENT( int iEdictNum )		{ return (*g_engfuncs.PEntityOfEntIndexAllEntities)(iEdictNum); }
...
typedef enum { point_hull=0, human_hull=1, large_hull=2, head_hull=3 } POINT_HULL;
